...
OptimizationParams = dict(
    ...
    prune_until_iter = -1,               # was 6000 (cutting-depthreg-aniso1e5-depth002) -- disabled (falls back to densify_until_iter=5000, cutting's real behavior); ablation isolating whether extending pruning past densification is what causes the small "orig" regression
    prune_scale_extent_ratio = 10.0,     # matches cutting-depthreg-aniso1e5-depth002 -- avoid floaters (scale.max() > 10 * camera_extent(10) = 100 gets pruned as a floater)
