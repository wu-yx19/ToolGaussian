...
OptimizationParams = dict(
    ...
    sideview_depth_weight = 0.01,        # same as cutting-depthreg
    ...
    anisotropy_weight = 1e-5,             # was 5e-5 (cutting-depthreg) -- testing whether a smaller anisotropy weight still suppresses the floater at a lower cost to the right view
