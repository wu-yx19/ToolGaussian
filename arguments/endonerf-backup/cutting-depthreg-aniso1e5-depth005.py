...
OptimizationParams = dict(
    ...
    sideview_depth_weight = 0.05,        # was 0.02 (cutting-depthreg-aniso1e5-depth002) -- pushing the depth_weight sweep further to find where the monotonic trend breaks down
