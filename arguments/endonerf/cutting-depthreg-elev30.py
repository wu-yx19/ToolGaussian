...
OptimizationParams = dict(
    ...
    sideview_depth_weight = 0.01,        # new: huber-loss weight on rendered side-view depth (0 in cutting) -- first guess, untuned
    ...
    sideview_elev = 30,                  # was 20 (cutting-depthreg) -- train the regularizer at the same elevation we care most about
    sideview_azims = -1,                 # matches cutting-sidereg's tuning, not cutting's own (inert, unused there) value of [0,90,180,270]
    anisotropy_weight = 5e-5,             # was 0 (cutting's real value) -- scale-only pruning missed a thin, needle-shaped floater; matches cutting-quadanireg's known-safe weight
