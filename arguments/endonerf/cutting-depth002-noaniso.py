...
OptimizationParams = dict(
    ...
    anisotropy_weight = 0,                # was 1e-5 (cutting-depthreg-aniso1e5-depth002) -- no anisotropy reg, ablation isolating the depth-reg-only effect (expect the needle floater to return, since anisotropy is what suppresses it)
