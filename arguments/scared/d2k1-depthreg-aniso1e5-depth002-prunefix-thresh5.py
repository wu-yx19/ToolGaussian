# RESULT: worse. Anisotropy did drop (median 5.20 -> 4.4, p99 13.7 -> 11.4) but elev15/20 fell to
# baseline level or below, and seed spread tripled. The model needs some elongated gaussians.
...
OptimizationParams = dict(
    ...
    anisotropy_ratio_threshold = 5.0,    # was 10.0 -- median gaussian sits at ratio ~5.2, so 10 left it unpenalized
)
