...
OptimizationParams = dict(
    ...
    # depth reg only (anisotropy off), splitting endonerf/cutting-depthreg-aniso1e5-depth002. The whole
    ...
    anisotropy_weight = 0,                # depth-reg-only arm of the depth x anisotropy grid
