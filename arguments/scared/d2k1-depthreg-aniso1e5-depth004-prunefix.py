# RESULT: indistinguishable from -depth002 once 3 seeds are run. The depth weight is not
# resolvable at this noise level; 0.005/0.01/0.04/0.08 all sit inside the seed spread.
...
OptimizationParams = dict(
    ...
    sideview_depth_weight = 0.04,        # 2x depth002 -- bracketing the sweep from above
