# RESULT: much worse than -depth002. With pruning fixed, the depth term is load-bearing.
...
OptimizationParams = dict(
    ...
    sideview_depth_weight = 0,           # no depth reg -- does the depth term earn its place once pruning is fixed?
