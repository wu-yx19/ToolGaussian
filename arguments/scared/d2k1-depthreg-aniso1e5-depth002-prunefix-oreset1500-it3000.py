# RESULT: unstable. Best original view (30.20) but elev20 seeds ranged 20.08-24.68, straddling
# baseline. Longer training undid the stability that -oreset1200 gave.
...
OptimizationParams = dict(
    ...
    position_lr_max_steps = 3000,        # track iterations, else position lr finishes decaying early
