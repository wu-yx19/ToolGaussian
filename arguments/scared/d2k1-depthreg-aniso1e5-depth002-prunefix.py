...
# Note prune_scale_extent_ratio=10.0 prunes nothing here -- max gaussian scale is ~134 vs a
# threshold of 10*extent(16.13)=161 -- so the gain comes from pruning_interval alone.
