# RESULT: the pruning fix on its own is NOT enough. 3-seed mean at elev5/10/15/20 is
# 27.12/25.35/23.85/22.13 vs baseline 26.71/24.64/23.02/21.81 -- the ranges overlap baseline
# everywhere, and seed2 collapsed to 25.65 at elev5. So the depth term is load-bearing; see
# d2k1-depth002-noaniso-prunefix, which adds it and reaches 28.62/27.29/25.64/23.66.
